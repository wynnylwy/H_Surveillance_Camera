...
<head> 
    <title> 
        Show Live Camera 2 - With Function
    </title> 
	...
	<section id="product">
        <div class="container">
			...
			<div class="row"> 
				...
				<div class="col-md-3">					
					<button id="btnStart" class="btn btn-success">Start Record</button>
					<br><br>
					<button id="btnStop" class="btn btn-danger">Stop Record</button>
					<br><br><br><br><br><br>
					<button id="btnSnap" class="btn btn-success">Snapshot Pic</button>
                </div>				
			</div><!-- /row -->
			...
			<div class="row"> 
				<div class="col-md-6">
					...
					<button class="btn btn-success"><a id="downloadButton">Download</a></button>
				</div>
			...
			<div class="row"> 
				<div class="col-md-6">	
					...
					<button class="btn btn-primary" onClick="window.location.href='showLiveCam2.php';">Live Camera 1</button>
...
//test getUserMedia 
	...
	if (navigator.mediaDevices === undefined) 
	{
		...
		mediaRecorder.onstop = (ev)=>{
			...
			downloadButton.href = vidSave.src;
            downloadButton.download = "Cam 2 Video.mp4";	
            }
        })
        .catch(function(err) { 
            console.log(err.name, err.message); 
