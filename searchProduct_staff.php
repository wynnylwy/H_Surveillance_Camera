...
<html>
<head>
	<title>Search Accessories - Staff</title>
</head>
<body>
<body>
<!-- PRE LOADER -->
	...
	<section id="product">
        <div class="container">
			<div class="section-title">
				<h2>View Certain CCTV Accessories<small>Enter Accessories ID</small></h2>
			</div>
            <br>
				...
				<div class="panel-body">
					<div class="row">	
						<div class="col-md-6 col-md-offset-4">
							<form class="form-horizontal" action="searchProduct_staff.php" method="POST" id="product-form">
					...
					<tr>
						<th colspan="6"><h4>CCTV Accessories list</h4></th>
					</tr>
					<t>
						<th>ID</th>				
						<th>Name</th>
					...
					<tr>
						...
						<td><a href="viewProductDetail_staff.php?AccessoriesID=<?php echo $rows['pid']; ?>">View</a></td>
					</tr>
					<?php     
						endwhile;
					?>   
