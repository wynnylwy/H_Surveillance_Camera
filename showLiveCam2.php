...
<head> 
    <title> 
        Show Live Camera - With Function
    </title> 
        ...
        <div class="container">
			...
			<div class="row"> 
				<div class="col-md-6">	
					...
					<button class="btn btn-primary" onClick="window.location.href='showLiveCam3.php';">Live Camera 2</button>
...
//test getUserMedia 
	...
	if (navigator.mediaDevices === undefined) 
	{
		...
		mediaRecorder.onstop = (ev)=>{
            ...
            downloadButton.download = "Cam 1 Video.mp4";	
            }
        })
        .catch(function(err) { 
            console.log(err.name, err.message); 
