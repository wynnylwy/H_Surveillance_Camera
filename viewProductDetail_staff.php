...
<?php 
	...
	if($result->num_rows == 1) {
		...
		echo "<script type='text/javascript'>alert('Accessories ID does not exists! Please insert correctly.');
			window.location='searchProduct_staff.php';
			</script>";			
		}
?>
<html>
<head>
	<title>View Accessories - Staff</title>
</head>
<body>
<!-- PRE LOADER -->
	...
	<section id="product">
        <div class="container">
			...
			<div class="col-md-6 col-sm-12">
				<br>
				<button class="btn btn-primary" onClick="window.location.href='searchProduct_staff.php';">Back</button>
			</div>
        </div><!-- container -->	
    </section>  
